        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UbicacionSucursal = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "PostulanteEmpresa",
                columns: table => new
                {
                    EmpresasID = table.Column<int>(type: "int", nullable: false),
                    PostulantesID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostulanteEmpresa", x => new { x.EmpresasID, x.PostulantesID });
                    table.ForeignKey(
